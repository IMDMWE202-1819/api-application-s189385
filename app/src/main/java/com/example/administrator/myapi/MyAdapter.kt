...
class MyAdapter(private val Tracks: ArrayList<Track>, val context: Context) : RecyclerView.Adapter<MyAdapter.ViewHolder>(){
    ...
    //Setting the data equal the the track being held by the View holder
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        private fun convertToMinutes(seconds: Int): String {
           var minutes = seconds/60.toFloat()
